...
if __name__ == "__main__":
    ...
    for icv, (train_index, test_index) in enumerate(kf.split(train_val)):
        ...
        for epoch in range(args.finetune.n_epochs):
            ...
            train_loss = trainer.train(model=model, loader=train_loader, optimizer=optimizer, scheduler=scheduler, device=device)
        ...
        res = get_predictions(trainer, val_loader, model, device)
