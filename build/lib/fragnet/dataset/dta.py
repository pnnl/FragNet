...
def create_dta_dataset(args):
    ...
    if args.save_parts == 0:
        ...
        save_ds_parts(data_creater=dataset, ds=train, output_dir=args.output_dir, fold='train')
        save_ds_parts(data_creater=dataset, ds=val, output_dir=args.output_dir, fold='val')
        save_ds_parts(data_creater=dataset, ds=test, output_dir=args.output_dir, fold='test')
