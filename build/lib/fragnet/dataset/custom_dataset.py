...
class MoleculeDataset:
    ...
    def get_toxcast(self):
        ...
        smiles_list, rdkit_mol_objs, labels = \
                _load_toxcast_dataset(raw_path)
    ...
    def get_clintox(self):
        ...
        smiles_list, rdkit_mol_objs, labels = \
                _load_clintox_dataset(raw_path)
