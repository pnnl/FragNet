...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name', help="moleculenet, moleculenet-custom", type=str, required=False, default="moleculenet")
    parser.add_argument('--dataset_subset', help="esol, freesolv", type=str, required=False, default=None)
    parser.add_argument('--output_dir', help="", type=str, required=False, default='finetune_data')
    parser.add_argument('--data_dir', help="", type=str, required=False, default='finetune_data')
    parser.add_argument('--frag_type', help="", type=str, required=False, default='brics')
    parser.add_argument('--use_molebert', help="", type=bool, required=False, default=False)
    ...
    parser.add_argument('--multi_conf_data', help="create multiple conformers for a smiles", type=int, required=False, default=0)
    parser.add_argument('--use_genes', help="whether a gene subset is used for cdrp data", type=int, required=False, default=0)
