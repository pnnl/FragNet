...
def create_general_dataset(args):
    ...
    if args.multi_conf_data == 1:
        ...
        dataset = FinetuneMultiConfData(target_name=args.target_name, data_type=args.data_type, frag_type=args.frag_type)
    else:
        print('generating single-conf data')
        dataset = FinetuneData(target_name=args.target_name, data_type=args.data_type, frag_type=args.frag_type)
