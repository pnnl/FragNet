...
def create_cdrp_dataset(args):
    ...
    if args.save_parts == 0:
        ...
        save_ds_parts(
            data_creater=dataset, ds=traindata, output_dir=args.output_dir, fold="train"
        )
        save_ds_parts(
            data_creater=dataset, ds=valdata, output_dir=args.output_dir, fold="val"
        )
        save_ds_parts(
            data_creater=dataset, ds=testdata, output_dir=args.output_dir, fold="test"
        )
