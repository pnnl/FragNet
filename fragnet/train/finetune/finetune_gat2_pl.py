...
import argparse
from fragnet.train.utils_pl import TrainerFineTune as Trainer
import numpy as np
...
if __name__ == "__main__":
    ...
    for epoch in range(args.finetune.n_epochs):
        ...
        train_loss = trainer.train(model=model, loader=train_loader, optimizer=optimizer, scheduler=scheduler, device=device, val_loader=val_loader, fabric=fabric)
