...
import torch
from data import collate_fn_dta as collate_fn
...
from dta_model.model import DTAModel2 as DTAModel
...
if __name__ == "__main__":
    ...
    import pandas as pd
    train_csv_path = args.finetune.train.path.replace('.pkl', '.csv')
    train_df = pd.read_csv(train_csv_path)
    labels = np.array(train_df['affinity'])
